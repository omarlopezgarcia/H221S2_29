...
app.post('/auth', function(request, response) {
	...
	if (username && password) {
		...
		connection.query('SELECT * FROM accounts WHERE username = omar.lopez@vallegrande.edu.pe AND password = omarlopez', [username, password], function(error, results, fields) {
